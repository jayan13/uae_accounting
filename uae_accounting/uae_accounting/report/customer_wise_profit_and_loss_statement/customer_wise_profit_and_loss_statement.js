...
frappe.query_reports["Customer Wise Profit and Loss Statement"] = $.extend(
	{},
	erpnext.financial_statements
);

erpnext.utils.add_dimensions("Customer Wise Profit and Loss Statement", 10);

frappe.query_reports["Customer Wise Profit and Loss Statement"]["filters"].push({
